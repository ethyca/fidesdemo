.DEFAULT_GOAL := help
.PHONY: help install server test fidesctl-init-db fidesctl-evaluate fidesops-request fidesops-test compose-up clean black
...
compose-up:
	@echo "Building & bringing up docker containers..."
